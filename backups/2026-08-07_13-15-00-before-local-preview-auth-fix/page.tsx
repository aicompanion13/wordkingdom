...
export default async function VersionThreePage() {
      ...
      <main className={styles.loginShell}>
        <section className={styles.loginCard}>
          ...
          <div>
            ...
            <a href={chatGPTSignInPath("/v3")}>SIGN IN WITH CHATGPT</a>
            <span>Your friends can use their own ChatGPT accounts. Royal QA is enabled for every tester.</span>
          </div>
        </section>
      </main>
    );
  ...
  return (
    <WordKingdomV3
      ...
      signOutUrl={chatGPTSignOutPath("/v3")}
    />
  );
}
